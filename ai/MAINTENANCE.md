...
```bash
gh issue list --repo TheTatu13/turbomecanica-sa-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "TURBOMECANICA SA", not the old template
